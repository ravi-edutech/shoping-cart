...
test('renders the landing page', () => {
    ...
    render(
        ...
        <Router>
            <Routes>   
                <Route path="*" element= {<FeaturedProduct category="smartphones"/>}/>
            </Routes>
        </Router>
        </Provider>
  ...
  const product1 = screen.getAllByTestId('1')
  fireEvent.click(product1[0])
  const product2 = screen.getAllByTestId('3')
  fireEvent.click(product2[0])
});
